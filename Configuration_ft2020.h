...
#define DEFAULT_MAX_FEEDRATE          {300, 300, 2, 22}    // (mm/sec)
#define DEFAULT_MAX_ACCELERATION      {2000,2000,5,1000}    // X, Y, Z, E maximum start speed for accelerated moves. E default values are good for Skeinforge 40+, for older versions raise them a lot.
