...
#define STRING_CONFIG_H_AUTHOR "(Greg Lincoln, for i3 Glide)" // Who made the changes.
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,400,152}  // default steps per unit for Ultimaker
#define DEFAULT_MAX_FEEDRATE          {300, 300, 5, 50}    // (mm/sec)
