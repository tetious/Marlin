...
#define STRING_CONFIG_H_AUTHOR "(Glide - v2017-08-01.2)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Glide - v2017-08-01.2"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 186 }
