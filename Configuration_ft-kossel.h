...
#define DELTA
  ...
  #define DELTA_SMOOTH_ROD_OFFSET 178 // mm
  ...
  #define DELTA_PRINTABLE_RADIUS (DELTA_SMOOTH_ROD_OFFSET-DELTA_EFFECTOR_OFFSET-DELTA_CARRIAGE_OFFSET)
...
#define STRING_CONFIG_H_AUTHOR "(GL, Kossel)" // Who made the changes.
