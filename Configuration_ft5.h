...
#define STRING_CONFIG_H_AUTHOR "(Greg Lincoln, for FT-5)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FT-5 (GL)"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,399,100}  // default steps per unit for Ultimaker
