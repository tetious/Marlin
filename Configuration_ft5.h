...
#define STRING_CONFIG_H_AUTHOR "FT-5 [2017-08-12.2]" // Who made the changes.
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_MESH_INSET 26        // Mesh inset margin on print area
  ...
  #define UBL_PROBE_PT_2_Y Y_PROBE_OFFSET_FROM_EXTRUDER
  #define UBL_PROBE_PT_3_X 270
